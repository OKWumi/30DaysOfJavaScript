//Exercise level 1 of day 2
/*1.Declare a variable named challenge and assign it to an initial value '30 Days Of JavaScript'.
*/
let challenge='30 Days Of JavaScript'

//2.Print the string on the browser console using
...
/*14.What is the character code of J in '30 Days Of JavaScript'
...
/*16.Use lastIndexOf to determine the position of the last occurrence
     of a in 30 Days Of JavaScript.
*/
console.log(challenge.lastIndexOf('a'))

/*17.Use indexOf to find the position of the first occurrence of the
     word because in the following sentence:'You cannot end a
     sentence with because because because is a conjunction'
*/
let string1='You can not end a statement with because because because is a conjunction'
...
/*21.Use startsWith() method with the string 30 Days Of JavaScript
     and make the result true
*/
console.log(challenge.startsWith('30'))

/*22.Use endsWith() method with the string 30 Days Of JavaScript and
